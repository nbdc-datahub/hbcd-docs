...
<b>Click to expand the following sections to view detailed file trees for release data (see <a href="../../datacuration/overview/#filetrees" target="_blank">How To Read File Trees</a>).</b>
