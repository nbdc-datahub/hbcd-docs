...
<p style="color: red;">(ADD REASONING FOR THESE THRESHOLDS)</p>
...
<p style="color: red;">(PROBABLY NEED TO DESCRIBE IN GREATER DETAIL WHAT WE MEAN BY "SERIOUS ISSUES" IDENTIFIED FOR EACH PIPELINE AND ALSO LAY OUT THE EXCLUSION LOGIC/DECISION TREE WAY MORE CLEARLY)</p>
