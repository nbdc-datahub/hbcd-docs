...
<table style="width: 100%; border-collapse: collapse; table-layout: fixed; font-size: 15px">
  <thead>
    ...
    <tbody>
    <tr>
        <td><a href="mri/smri" target="_blank">Structural MRI (sMRI)</a></td>
        <td><a href="../datacuration/rawbids/#anatomical-anat" target="_blank"><i>anat/</i></a></td>
    </tr>
    <tr>
        <td><a href="mri/qmri" target="_blank">Quantitative MRI (qMRI)</a></td>
        <td><a href="../datacuration/rawbids/#anatomical-anat" target="_blank"><i>anat/</i></a></td>
    </tr>
    <tr>
        <td><a href="mri/fmri" target="_blank">Functional MRI (fMRI)</a></td>
        <td><a href="../datacuration/rawbids/#functional-func-and-fieldmaps-fmap" target="_blank"><i>func/</i>, <i>fmap/</i></a></td>
    </tr>
    <tr>
        <td><a href="mri/dmri" target="_blank">Diffusion MRI (dMRI)</a></td>
        <td><a href="../datacuration/rawbids/#diffusion-dwi" target="_blank"><i>dwi/</i></a></td>
    </tr>
    <tr>
        <td><a href="mri/mrs" target="_blank">MR Spectroscopy (MRS)</a></td>
        <td><a href="../datacuration/rawbids/#mrs" target="_blank"><i>mrs/</i></a></td>
    </tr>
</tbody>
</table>
</div>
