...
<i>See the <a href="../../../datacuration/overview" target="_blank">Data Structure Overview</a> for a full explanation of these data types.</i>
 ...
 - <i class="fa fa-hammer"></i> **Raw BIDS** stored under subject- and session-specific <code>anat/</code> and `fmap/` folders - see [MR Raw BIDS](raw-bids.md#anatomical-files-anat)
 - <i class="fas fa-cog"></i> **Derivatives** generated by the SyMRI & qMRI Postproc pipelines *([expand infobox](#derivatives))*
