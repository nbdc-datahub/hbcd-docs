...
Motion/accelerometry data collected from wearable infant leg sensors includes **file-based** (raw and processed data files in modality-specific formats). <i>See <a href="../../../datacuration/overview" target="_blank">Data Structure Overview</a> for an explanation of these data types.</i>
 ...
 - <i class="fa fa-hammer"></i> **Raw BIDS** stored under subject- and session-specific <code>motion/</code> folders 
 - <i class="fas fa-cog"></i> **Derivatives** generated by the HBCD-Motion pipeline
...
See <a href="https://doi.org/10.1038/s41597-024-03559-8" target="_blank">Jeung et al., 2024</a> for a description of BIDS conversion procedures.</p>
