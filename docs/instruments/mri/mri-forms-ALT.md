...
MRI summary forms are checklists completed by MRI technicians before and after each scan session. Expand the sections below for an overview of the information included in the post-scan Data Summary Form.
...
<td><i class="fa fa-square-check" style="color: #00aeae; margin-right: 0.5em"></i> Bottle feeding; Breast feeding; Bath; Reading; Other</td>
</tr>
<tr>
...
<td><i class="fa fa-square-check" style="color: #00aeae; margin-right: 0.5em"></i> Playtime; Breast feeding; Bottle feeding; Eating/drinking something else</td>
</tr>
<tr>
