...
<p><b>3. If &gt;40% of the scale items are missing (e.g., there are only 7/12 completed responses in a scale), it is not possible to score the individual domain.</b></p>
