...
<table class="table-no-vertical-lines">
  ...
  <tr>
    ...
    <tr>
    <td><a href="/instruments/demo/visitinfo" target="_blank">Visit Level Data</a></td>
...
<tbody>
<tr>
<td><a href="/instruments/admin/study-navigators" target="_blank">Study Navigator Contact Form</a> <i class="fas fa-layer-group table-icon"></i></td>
...
<thead>
  ...
  <tbody>
  <tr>
    <td><a href="/instruments/bcgi/chaos" target="_blank">CHAOS</a></td>
    <td>Family Organization</td>
    <td><code>mh_cg_chaos</code></td>
  </tr>
  <tr>
    <td>
      <a href="/instruments/bcgi/ecpromis" target="_blank">ecPROMIS Caregiver-Child</a> <i>(&lt;1 / 1-5 years)</i></td>
    <td>Caregiver-Child Interactions</td>
    <td><code>mh_cg_pms__cc__inf</code> / <code>mh_cg_pms__cc__1to5</code></td>
  </tr>
  <tr>
    <td><a href="/instruments/bcgi/ecpromis-pr" target="_blank">ecPROMIS Peer</a></td>
    <td>Peer Relationships</td>
    <td><code>mh_cg_pms__peer</code></td>
  </tr>
  <tr>
    <td><a href="/instruments/bcgi/ecpromis-selfreg" target="_blank">ecPROMIS Self-Regulation</a></td>
    <td>Self-Regulation and Flexibility</td>
    <td><code>mh_cg_pms__selfreg</code></td>
  </tr>
  <tr>
    <td><a href="/instruments/bcgi/erica" target="_blank">ERICA</a></td>
    <td>Emotional Regulation</td>
    <td><code>mh_cg_erica</code></td>
  </tr>
  <tr>
    <td><a href="/instruments/bcgi/fad" target="_blank">FAD (GF6+)</a></td>
  ...
  <tr>
    <td><a href="/instruments/bcgi/ibqr" target="_blank">ECBQ (VSF)+BI</a></td>
    <td><code>mh_cg_ecbq</code></td>
  </tr>
  <tr>
    <td><a href="/instruments/bcgi/maps-tl" target="_blank">MAPS-TL</a> <i>(Infant / Toddler)</i></td>
    <td>Irritability</td>
    <td>
...
<tbody>
<tr>
    <td><a href="/instruments/biospec/illumina-gda-gwas" target="_blank">Illumina GDA GWAS</a><i class="fas fa-layer-group table-icon"></i></td>
...
<tr>
    <td><a href="/instruments/biospec/nails" target="_blank">Maternal Nails</a></td>
    <td>Maternal</td>
...
<tr>
    <td><a href="/instruments/biospec/urine" target="_blank">Maternal Urine</a></td>
    <td>Maternal</td>
...
<tr>
    <td><a href="/instruments/biospec/olink" target="_blank">Olink Explore</a> <i class="fas fa-layer-group table-icon"></i></td>
    <td></td>
...
<tbody>
<tr>
  <td><a href="/instruments/neurocog/bayley-4" target="_blank">Bayley-4 Scales</a></td>
  <td></td>
  <td>Child Development (Cognitive, Language, and Motor)</td>
  <td><code>ncl_ch_bayley</code></td>
</tr>
<tr>
  <td rowspan="2"><a href="/instruments/neurocog/macarthur-bates" target="_blank">MacArthur-Bates CDI-I</a></td>
  <td>English</td>
...
<tr>
  <td><a href="/instruments/neurocog/mlds" target="_blank">MLDS</a></td>
  <td></td>
  <td>Multilingual Exposure</td>
  <td><code>ncl_ch_mlds</code></td>
</tr>
<tr>
  <td rowspan="2"><a href="/instruments/neurocog/spm2" target="_blank">Sensory Processing Measure-2 (SPM-2)</a></td>
  <td>Infant</td>
...
<tr>
  <td><a href="/instruments/neurocog/vineland" target="_blank">Vineland Adaptive Behavior</a></td>
  <td></td>
...
<tbody>
<tr>
  <td><a href="/instruments/physhealth/bisq-sf" target="_blank">Brief Infant Sleep Questionnaire</a></td>
  <td></td>
  <td>Sleep</td>
  <td><code>ph_cg_bisq</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/bf" target="_blank">Breast Feeding History</a></td>
  <td></td>
  <td>Nutrition</td>
  <td><code>ph_cg_phx__bfh</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/ecpromis-pags" target="_blank">ecPROMIS Physical Activity/Greenspace</a></td>
  <td>Early Childhood</td>
  <td>Physical Activity</td>
  <td><code>ph_cg_pms__pags</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/ecpromis-sleep" target="_blank">ecPROMIS Sleep</a></td>
  <td>Early Childhood</td>
  <td>Sleep</td>
  <td><code>ph_cg_pms__sleep</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/growth" target="_blank">Height/Weight/Head Circumference</a></td>
  <td></td>
  <td>Growth</td>
  <td><code>ph_ch_anthro</code></td>
</tr> 
<tr>
  <td><a href="/instruments/physhealth/medical-history" target="_blank">Medical History</a></td>
  <td></td>
  <td>Medical History</td>
  <td><code>ph_cg_ecls__medhist</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/nutrition" target="_blank">Nutrition Questionnaire</a></td>
  <td>Infant</td>
  <td>Nutrition</td>
  <td><code>ph_cg_inq</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/screenq" target="_blank">ScreenQ</a></td>
  <td></td>
  <td>Media Use</td>
  <td><code>ph_cg_screenq</code></td>
</tr>
<tr>
  <td><a href="/instruments/physhealth/vision" target="_blank">Vision Screener</a></td>
  <td></td>
  <td>Vision</td>
...
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-Health History</a></td>
  <td>Pre-pregnancy and pregnancy health</td>
  <td><code>pex_bm_health_preg__healthhx</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-Exp & Vaccines</a></td>
  <td>Vaccines in pregnancy</td>
  <td><code>pex_bm_health_preg__exp__vacc</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-Chronic Conditions</a></td>
  <td>Chronic conditions/STIs in pregnancy</td>
  <td><code>pex_bm_health_preg__chroncond</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-Illness</a></td>
  <td>Illness in pregnancy</td>
  <td><code>pex_bm_health_preg__illness</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-ER Admissions</a></td>
  <td>ER visit or hospitalization in pregnancy</td>
  <td><code>pex_bm_health_preg__erhosp</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V1-Medications</a></td>
  <td>Medications in pregnancy</td>
  <td><code>pex_bm_health_preg__meds</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V2-Pregnancy</a></td>
  <td>Health updates up to delivery</td>
  <td><code>pex_bm_healthv2_preg</code></td>
</tr>
<tr class="section-health">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-baby header-icon"></i> <a href="/instruments/pregexp/pex/" target="_blank">Health V2-Infancy</a></td>
  <td>Delivery and birth outcomes</td>
  <td><code>pex_bm_healthv2_inf</code></td>
</tr>
<!-- Mental Health -->
<tr class="section-mh">
  <td><i style="color: #ff5df7ff;" class="fas fa-brain header-icon"></i> <a href="/instruments/pregexp/mh/fam-mh" target="_blank">FAM MH</a></td>
  <td>Personal and Family Mental Health</td>
  <td><code>pex_bm_psych</code></td>
</tr>
<tr class="section-mh">
  <td><i style="color: #ff5df7ff;" class="fas fa-brain header-icon"></i> <a href="/instruments/pregexp/mh/apa12" target="_blank">APA 1/2</a></td>
  <td>Mental Health</td>
  <td><code>pex_bm_apa</code></td>
</tr>
<tr class="section-mh">
  <td><i style="color: #ff5df7ff;" class="fas fa-brain header-icon"></i> <a href="/instruments/pregexp/mh/ptsd" target="_blank">DSM5 Acute Stress or PTSD</a></td>
  <td>PTSD/Acute Stress Symptom Severity</td>
  <td><code>pex_bm_str__ptsd</code></td>
</tr>
<tr class="section-mh">
  <td><i style="color: #ff5df7ff;" class="fas fa-brain header-icon"></i> <a href="/instruments/pregexp/mh/epds" target="_blank">EPDS</a></td>
  <td>Postnatal Depression</td>
  <td><code>pex_bm_epds</code></td>
</tr>
<!-- Substance Use -->
<tr class="section-su">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-prescription-bottle header-icon"></i> <a href="/instruments/pregexp/su/assist" target="_blank">ASSIST V1/2/3/4</a></td>
  <td>Substance Use Pre-, During, and Post-Pregnancy</td>
  <td><code>pex_bm_assistv<span class="blue-text">{1|2|3|4}</span></code></td>
</tr>
<tr class="section-su">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-prescription-bottle header-icon"></i> <a href="/instruments/pregexp/su/su-patterns" target="_blank">Substance Use Patterns</a></td>
  <td>Substance Use in Pregnancy</td>
  <td><code>pex_bm_subst</code></td>
</tr>
<tr class="section-su">
  <td><i style="color: #ff5df7ff;" class="fa-solid fa-prescription-bottle header-icon"></i> <a href="/instruments/pregexp/su/tlfb" target="_blank">TLFB</a></td>
...
<tr>
  <td rowspan="2"><a href="/instruments/SED/aces" target="_blank">Adverse Childhood Experiences</a></td>
  <td>ACEs</td>
...
<tr>
  <td><a href="/instruments/SED/bfy" target="_blank">Baby's First Years (BFY)</a></td>
  <td></td>
  <td>Benefits/Services/Economic Stress</td>
  <td><code>sed_bm_bfy</code></td>
</tr>
<tr>
  <td><a href="/instruments/SED/cab" target="_blank">Composite Abuse Scale (CABr-SF)</a></td>
  <td></td>
  <td>Intimate Partner Violence</td>
  <td><code>sed_cg_cabr_sf</code></td>
</tr>
<tr>
  <td><a href="/instruments/SED/current-employment" target="_blank">Current Employment</a></td>
  <td></td>
  <td>Current Employment</td>
  <td><code>sed_cg_employ</code></td>
</tr>  
<tr>
  <td><a href="/instruments/SED/demo-cg" target="_blank">Demographics</a></td>
  <td>Adult</td>
  <td>Demographics (Adult V01, V04, V06)</td>
  <td><code>sed_bm_demo</code></td>
</tr> 
<tr>
  <td><a href="/instruments/SED/demo-ch" target="_blank">Child Demographics</a></td>
  <td>Child</td>
  <td>Demographics (Child V04, V06)</td>
  <td><code>sed_bm_demo_child</code></td>
</tr> 
<tr>
  <td><a href="/instruments/SED/ehits" target="_blank">eHITS</a></td>
  <td></td>
  <td>Intimate Partner Violence</td>
  <td><code>sed_bm_ehits</code></td>
</tr>  
<tr>
  <td><a href="/instruments/SED/foodinsecurity" target="_blank">Food Insecurity</a></td>
  <td></td>
...
<tr>
  <td><a href="/instruments/SED/geocoded-linkage" target="_blank">Geocoded Linkage</a> <i class="fas fa-layer-group table-icon"></i></td>
  <td></td>
...
<tr>
  <td><a href="/instruments/SED/home21" target="_blank">HOME-21</a></td>
  <td>Infant-Toddler</td>
  <td>Child’s Home Environment</td>
  <td><code>sed_cg_home_it</code></td>
</tr>
<tr>
  <td><a href="/instruments/SED/household-chemical-exposures" target="_blank">Household Chemical Exposures</a></td>
  <td></td>
  <td>Household Chemical Exposures</td>
  <td><code>sed_cg_hce</code></td>
</tr>   
<tr>
  <td><a href="/instruments/SED/lead-exposures" target="_blank">Lead Exposures</a></td>
  <td></td>
  <td>Lead Exposures</td>
  <td><code>sed_cg_leadexp</code></td>
</tr> 
<tr>
  <td><a href="/instruments/SED/safety" target="_blank">Neighborhood Safety</a></td>
  <td></td>
  <td>Neighborhood Safety</td>
  <td><code>sed_bm_nbhsaf</code></td>
</tr> 
<tr>
  <td rowspan="2"><a href="/instruments/SED/paces" target="_blank">PACEs</a></td>
  <td>Current</td>
...
<tr>
  <td><a href="/instruments/SED/second-hand-smoke-exposure" target="_blank">Second Hand Smoke</a></td>
  <td></td>
  <td>Second Hand Smoke Exposure</td>
  <td><code>sed_cg_shs</code></td>
</tr>    
<tr>
  <td><a href="/instruments/SED/transitions-in-care" target="_blank">Transitions in Care Screener</a></td>
  <td></td>
  <td>Recruitment/Retention</td>
  <td><code>sed_cg_tic_screener</code></td>
</tr>
<tr>
  <td><a href="/instruments/SED/discr" target="_blank">Unfair Treatment</a></td>
  <td></td>
  <td>Experiences of Unfair Treatment</td>
  <td><code>sed_bm_phx__discr</code></td>
</tr>  
<tr>
  <td><a href="/instruments/SED/vi" target="_blank">Vancouver Index (VIA)</a></td>
  <td></td>
  <td>Acculturation</td>
