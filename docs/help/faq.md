...
<p>Note that the <b>source</b> component of table names also typically indicates whether the data came from the caregiver, child, or another source. However, the meaning of source is not consistent across all instruments at this time - please see <a href="../../access/metadata/#naming-conventions">Naming Conventions</a> for details.</p>
</div>
