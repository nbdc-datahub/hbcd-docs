...
<i>See the <a href="../../../datacuration/overview" target="_blank">Data Structure Overview</a> for a full explanation of these data types.</i>
 ...
 - <i class="fa fa-hammer"></i> **Raw BIDS** stored under subject- and session-specific <code>mrs/</code> folders - see [MR Raw BIDS](raw-bids.md#mrs-mrs)
 - <i class="fas fa-cog"></i> **Derivatives** generated by OSPREY-BIDS
