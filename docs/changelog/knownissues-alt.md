...
<p><b>Domains <i>(click icons to view full list of associated instruments)</i></b></p>
...
<p style="font-size: 1em; color: #555; margin-bottom: 0.5px;">
...
<td style='word-wrap: break-word; white-space: normal;'>The creatinine results (<code>bio_creat_u</code>) variable is currently excluded from the release due to out-of-range values and will be added once corrected.</td>
<td style='text-align: center;'>3</td>
</tr>
...
<td style='word-wrap: break-word; white-space: normal;'>Addition of summary scores (Summed Score, T-score, and SE). Until added, users can calculate summary scores themselves by following the Scoring Procedures documented on the instrument page.</td>
<td style='text-align: center;'>3</td>
</tr>
...
<span class="table-name">C-PACEs</span>
</td>
