...
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
<td>Language</td>
<td style='word-wrap: break-word; white-space: normal;'>Add language of administration across all instruments where applicable.</td>
<td style='text-align: center;'><span class='pr-pill pr-general'>2.1</span></td>
</tr>
<tr>
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
...
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
<td>Vineland</td>
<td style='word-wrap: break-word; white-space: normal;'>Add language field to <code>ncl_cg_vabs</code>.</td>
<td style='text-align: center;'><span class='pr-pill pr-general'>2.1</span></td>
</tr>
</tbody></table>
...
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
<td>PEX Health</td>
<td style='word-wrap: break-word; white-space: normal;'>ICD codes for the <code>pex_bm_health*</code> tables are inconsistently provided, sometimes missing corresponding names/labels. For example, medication names are present for the <em>Health V1- Medications</em>, while the <em>Health V2- Pregnancy</em> instrument only has medication codes without corresponding labels. Until resolved, users can use external packages to merge ICD labels if needed: <a href="https://www.stata.com/features/overview/icd/">Stata</a>, <a href="https://hcup-us.ahrq.gov/toolssoftware/ccsr/dxccsr.jsp">SAS</a>, <a href="https://www.rdocumentation.org/packages/icd/versions/3.3">R</a></td>
<td style='text-align: center;'><span class='pr-pill pr-general'>3</span></td>
</tr>
</tbody></table>
...
<td><i class="fas fa-bug icon-bug"></i></td>
<td>Demo</td>
<td style='word-wrap: break-word; white-space: normal;'>The variables <code>sed_bm_demo_residence_{001|002}</code>, present in the prior release, are missing in the current release.</td>
<td style='text-align: center;'><span class='pr-pill pr-general'>2.1</span></td>
</tr>
<tr>
<td><i class="fas fa-bug icon-bug"></i></td>
...
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
<td>Child Demo</td>
<td style='word-wrap: break-word; white-space: normal;'>Household roster will be updated to clarify that counts exclude the main child - see <a href="https://docs.hbcdstudy.org/latest/instruments/SED/demo-ch/#warning">Data Warning</a> ("Household Roster")</td>
<td style='text-align: center;'><span class='pr-pill pr-general'>2.1</span></td>
</tr>
<tr>
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
...
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
<td>Demo</td>
<td style='word-wrap: break-word; white-space: normal;'>Add <code>work_{002–004}_post</code> (worked for pay + for X hours while pregnant) and <code>work_004__01</code> (job held ≥1 month since V01) (adult table).</td>
<td style='text-align: center;'><span class='pr-pill pr-general'>2.1</span></td>
</tr>
<tr>
<td><i class="fa-solid fa-rotate icon-rotate"></i></td>
