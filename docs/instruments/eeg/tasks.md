...
<div id="warning-mmn" class="banner warn" onclick="toggleCollapse(this)">
...
<div id="mmn-ref" class="banner" onclick="toggleCollapse(this)">
  ...
  <a class="anchor-link" href="#mmn-ref" title="Copy link">
  <i class="fa-solid fa-link"></i>
  </a>
  </span>
  <span class="arrow">▸</span>
...
<div id="warning-face" class="banner warn" onclick="toggleCollapse(this)">
  <span class="emoji"><i class="fas fa-exclamation-triangle"></i></span>
  <span class="text-with-link">
  <span class="text">Data Warning</span>
...
<div id="face-ref" class="banner" onclick="toggleCollapse(this)">
  ...
  <span class="text-with-link">
  <span class="text">References</span>
  <a class="anchor-link" href="#face-ref" title="Copy link">
  <i class="fa-solid fa-link"></i>
  </a>
  </span>
  <span class="arrow">▸</span>
...
<div id="warning-vep" class="banner warn" onclick="toggleCollapse(this)">
  <span class="emoji"><i class="fas fa-exclamation-triangle"></i></span>
  <span class="text-with-link">
  <span class="text">Data Warning</span>
...
<div id="vep-ref" class="banner" onclick="toggleCollapse(this)">
  ...
  <span class="text-with-link">
  <span class="text">References</span>
  <a class="anchor-link" href="#vep-ref" title="Copy link">
  <i class="fa-solid fa-link"></i>
  </a>
  </span>
  <span class="arrow">▸</span>
...
<div id="warning-rs" class="banner warn" onclick="toggleCollapse(this)">
  <span class="emoji"><i class="fas fa-exclamation-triangle"></i></span>
  <span class="text-with-link">
  <span class="text">Data Warning</span>
...
<div id="rs-ref" class="banner" onclick="toggleCollapse(this)">
  ...
  <span class="text-with-link">
  <span class="text">References</span>
  <a class="anchor-link" href="#rs-ref" title="Copy link">
  <i class="fa-solid fa-link"></i>
  </a>
  </span>
  <span class="arrow">▸</span>
