...
<tbody>
<tr>
  <td><a href="mri/smri" target="_blank">Structural MRI</a></td>  <td>sMRI</td>
  <td><code>anat/</code></td>
  <td>MRIQC • BIBSNet</td>
</tr>
<tr>
  <td><a href="mri/fmri" target="_blank">Functional MRI</td>  <td>fMRI</td>
  <td><code>func/</code>, <code>fmap/</code></td>
  <td>
    MRIQC • Infant fMRIPrep + FreeSurfer / M-CRIB-S • XCP-D</td>
</tr>
<tr>
  <td><a href="mri/qmri" target="_blank">Quantitative MRI</td>  <td>qMRI</td>
  <td><code>anat/</code>, <code>fmap/</code></td>
  <td>SyMRI & qMRI PostProc</td>
</tr>
<tr>
  <td><a href="mri/dmri" target="_blank">Diffusion MRI</td>  <td>dMRI</td>
  <td><code>dwi/</code></td>
  <td>QSIPrep & QSIRecon (DSI Studio, DIPY DKI, TORTOISE)</td>
</tr>
<tr>
  <td><a href="mri/mrs" target="_blank">MR Spectroscopy</td>  <td>MRS</td>
  <td><code>mrs/</code></td>
  <td>OSPREY-BIDS</td>
</tr>
</tbody>
...
<div class="table-legend"> <span class="legend-item">
<i class="fa-solid fa-diagram-project legend-icon"></i> = Tabulated pipeline derivatives, i.e. data combined across participant derivatives into a single TSV - <a href="../datacuration/overview/#tabulated-pipeline-derivatives" target="_blank">see details</a> </span>
</div> 
<table class="compact-table-no-vertical-lines index"> 
<thead> <tr> <th>Table</th> <th>Table Name</th> </tr> </thead>
<tbody>
 <tr> <td><a href="mri/smri/#bibsnet-derivs" target="_blank">BIBSNet</a> <i class="fa-solid fa-diagram-project table-icon"></i></td> <td><code>img_bibsnet_space-<span class="blue-text">{T1w|T2w}</span>_desc-aseg_volumes</code></td> </tr> 
 
 <tr> <td><a href="mri/qc#brainswipes" target="_blank">BrainSwipes</a> (QC)</td> <td> <code>img_brainswipes_xcpd_hash-0f306a2f+0ef9c88a_<span class="blue-text">{T2w|bold}</span></code><br> <code>img_brainswipes_xcpd_hash-2afa9081+0ef9c88a_<span class="blue-text">{T1w|bold}</span></code> </td> </tr> 
 
 <tr> <td><a href="mri/smri/#mriqc" target="_blank">MRIQC</a> <i class="fa-solid fa-diagram-project table-icon"></i></td> <td><code>img_mriqc_<span class="blue-text">{T1w|T2w|bold}</span></code></td> </tr> 
 
 <tr> <td> <a href="mri/mri-forms/#mri-scan-session-data-summary-forms" target="_blank">MRI Summary</a> (Tech Forms)</td> <td><code>mri_ra_chkl_scan</code><br> <code>mri_ra_chkl_data</code> </td> </tr> <tr> <td><a href="mri/mrs/#derivatives" target="_blank">OSPREY-BIDS</a> <i class="fa-solid fa-diagram-project table-icon"></i></td> <td> <code>img_osprey_HERCULES_<span class="blue-text">{diff1|diff2|sum}</span>_AlphaCorrWaterScaledGroupNormed_Voxel_1_Basis_1</code><br> <code>img_osprey_HERCULES_<span class="blue-text">{diff1|diff2|sum}</span>_<span class="blue-text">{AlphaCorr|CSF|raw|TissCorr}</span>WaterScaled_Voxel_1_Basis_1</code><br> <code>img_osprey_HERCULES_<span class="blue-text">{diff1|diff2|sum}</span>_<span class="blue-text">{amplMets|tCr}</span>_Voxel_1_Basis_1</code><br> <code>img_osprey_unedited_A_AlphaCorrWaterScaledGroupNormed_Voxel_1_Basis_1</code><br> <code>img_osprey_unedited_A_<span class="blue-text">{AlphaCorr|CSF|raw|TissCorr}</span>WaterScaled_Voxel_1_Basis_1</code><br> <code>img_osprey_unedited_A_<span class="blue-text">{amplMets|tCr}</span>_Voxel_1_Basis_1</code><br> <code>img_osprey_<span class="blue-text">{HERCULES|unedited}</span>_qm_processed_spectra</code><br><br> <a href="mri/tables/osprey.html" target="_blank">View full filename list →</a> </td> </tr> <tr> <td><a href="mri/prescan-questionnaire" target="_blank">Pre-Scan Form</a> (Infant Sleep)</td> <td><code>mri_ra_prep</code></td> </tr> <tr> <td><a href="mri/dmri/#qsiprep" target="_blank">QSIPrep</a> <i class="fa-solid fa-diagram-project table-icon"></i></td> <td><code>img_qsiprep_space-ACPC_desc-image_qc</code></td> </tr> <tr> <td><a href="mri/fmri/#xcp-d" target="_blank">XCP-D</a> <i class="fa-solid fa-diagram-project table-icon"></i></td> <td> <code>img_xcpd_hash-<span class="blue-text">{HASH}</span>_space-fsLR_seg-<span class="blue-text">{PARC}</span>_stat-mean_desc-<span class="blue-text">{curv|sulc|thickness}</span>_morph</code><br> <code>img_xcpd_hash-<span class="blue-text">{HASH}</span>_space-fsLR_seg-<span class="blue-text">{PARC}</span>_stat-<span class="blue-text">{alff|coverage|reho}</span>_bold</code><br> <br> &nbsp;&nbsp;&nbsp;<code><span class="blue-text">HASH</span></code> values: <code>0f306a2f+0ef9c88a</code> , <code>2afa9081+0ef9c88a</code><br> &nbsp;&nbsp;&nbsp;<code><span class="blue-text">PARC</span></code> values: <code>Glasser</code> , <code>Gordon</code> , <a href="mri/fmri/#parc" target="_blank">etc.</a><br> <br> <a href="mri/tables/xcpd.html" target="_blank">View full filenames list →</a> </td> </tr> </tbody> </table>
</div>
