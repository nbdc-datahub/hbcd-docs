...
Note that there are negative values in the <code>bio_c_cot_u</code> variable. While technically not an error in the data, these will be converted to zeros in the next release.</p>
</div>
