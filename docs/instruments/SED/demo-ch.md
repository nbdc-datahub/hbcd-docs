...
The item “How many days per month do you live with the child?” (<code>sed_bm_demo_child__relat_002__01</code>) was frequently answered incorrectly by a subset of participants. A notable number responded “7,” suggesting some respondents may have interpreted the question as referring to days per week rather than per month. The question formatting has since been revised to emphasize “per month” and to present 30 as the first response option. Users should interpret earlier responses (in V04) with caution, as some values may reflect misunderstanding of the reference period.
</div>
