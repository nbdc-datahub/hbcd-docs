...
<i>See the <a href="../../datacuration/overview" target="_blank">Data Structure Overview</a> for a full explanation of these data types.</i>
 ...
 - <i class="fa fa-hammer"></i> **Raw BIDS** stored under subject- and session-specific <code>eeg/</code> folders 
 - <i class="fas fa-cog"></i> **Derivatives** generated by the HBCD-MADE pipeline
 - <i class="fas fa-table"></i> **Tabulated data** derived from pipeline outputs — see <a href="../../#eeg" target="_blank">EEG Tabulated Data</a>
