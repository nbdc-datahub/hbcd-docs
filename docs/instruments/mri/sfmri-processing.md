...
# Structural & Functional Processing & Derivatives
...
<p>For structural and functional MRI processing, file selection is based on raw data quality control metrics, including:</p>
<ul>
