...
The Olink datasets are provided as [concatenated data](../../datacuration/file-based-data.md#concatenated-data), including two versions of the main data to support different analysis workflows:
