...
## Health V1 & V2 Instruments Overview

Health V1 & V2 instruments include 8 separate questionnaires administered in-person or remote (Parent on Child for HealthV2 Inf and on Self for all others; V1 instruments 3-5 minutes each and V2 instruments 10 minutes each). Quality control is performed by reviewing response distributions for outliers.
...
{{ alert_warning(instruments.healthhx) }}
