...
{{ data_warning(instruments.mbcdi) }}
{{ issues_banner() }}

## Instrument Details

{{ instrument_description(instruments.mbcdi) }}
{{ hbcd_mods(instruments.mbcdi) }}
{{ scoring(instruments.mbcdi) }}
{{ references(instruments.mbcdi) }}
