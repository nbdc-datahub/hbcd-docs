# File-Based Data: Raw BIDS & Derivatives

File-based data includes imaging, EEG, and biosensor recordings. Unlike [tabulated](phenotypes.md) data (tables organized in a uniform way across study instruments), file-based data comes in a variety of formats, often modality-specific. File-based data includes:

 - **[Raw BIDS](#raw-bids)**: raw data converted to the BIDS standard with unaltered signal content
 - **[Derivatives](#processed-derivatives)**: processed datasets generated by standardized pipelines
