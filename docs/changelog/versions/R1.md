...
<tr>
<td colspan="1" rowspan="2"><strong>Domain Filters</strong></td>
...
<div id="field-values" class="table-banner" onclick="toggleCollapse(this)">
  <span class="emoji"><i class="fa-solid fa-filter"></i></span>
  <span class="text-with-link">
  <span class="text">Field Value Filters & Conversion</span>
...
<tbody>
<tr>
  <td colspan="2"><strong>General Field Value Conversions</strong></td>
</tr>        
<tr>
  <td><strong>All Fields</strong></td>  
  <td>Empty strings (“”) or missing values are replaced with the default ReproSchema-compliant string “n/a”</td>  
</tr>  
<tr>
  <td rowspan="2"><strong>All V01 data fields</strong></td>  
  <td>Sex is changed from "Male/Female" to “Other” for all participants with only one active V01 visit</td>  
</tr> 
<tr>
  <td>All “Candidate_Age” values are replaced with “n/a”</td> 
</tr> 
</tbody>
</table>
<table class="table-no-vertical-lines" style="width: 100%; border-collapse: collapse; table-layout: fixed;">
<thead>
  <tr><td colspan="4"><strong>Filtered out-of-range values <i>(values outside of valid range converted to "n/a")</i></strong></td></tr>
  <tr> 
  <th>Instrument</th>
  <th>Field Name</th>    
