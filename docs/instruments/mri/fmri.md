...
<div class="table-collapsible-content">
<p>XCP-D performs functional MRI post-processing and noise regression from Infant-fMRIPrep derivatives. See the XCP-D documentation on <a href="https://xcp-d.readthedocs.io/en/latest/outputs.html#functional-timeseries-and-connectivity-matrices">"HBCD mode" functional outputs</a>.
