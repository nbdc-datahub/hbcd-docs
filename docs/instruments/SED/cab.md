...
{{ readme(instruments.cabr_sf) }}
{{ alert_warning(instruments.cabr_sf) }}
{{ data_warning(instruments.cabr_sf) }}
{{ issues_banner_macro() }}
...
{{ hbcd_mods(instruments.cabr_sf) }}
{{ scoring(instruments.cabr_sf) }}
...
<!-- <p style="font-size: 1.4em; font-weight: 500; color: gray;"><i>Composite Abuse Scale Revised - Short Form</i></p>
...
<b>Method</b>: Self-administered in person in a private setting (2 min estimated duration)
</td></tr>
<tr>
